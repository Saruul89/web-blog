...
const SearchPageHicheel = () => {
  const [searchValue, setSearchValue] = useState(""); //useState oorchlogdoh blgon render buyu update hiih blhoor
...
export default SearchPageHicheel;
